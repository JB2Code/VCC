...
- **Preset-Anfahrt drosselbar** (Regler „Preset-Anfahrt", 1–14): langsameres Anfahren
  ist ruhiger und meist wiederholgenauer. Nutzt eine Hersteller-Erweiterung des
  VISCA-Protokolls — Kameras, die sie nicht kennen, ignorieren den Befehl folgenlos
...
- `Visca/ViscaClient.cs` — VISCA-over-IP-Befehle (Pan/Tilt/Zoom/Fokus/Presets 1–254).
  Hält die Verbindung offen: alle 20 s geht eine folgenlose Abfrage raus, weil die Kamera
  einen untätigen Socket sonst nach etwa einer Minute schließt. Reißt die Verbindung
  trotzdem ab, verbindet der Client selbstständig neu
